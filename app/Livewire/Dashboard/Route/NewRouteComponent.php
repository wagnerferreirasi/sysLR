...
class NewRouteComponent extends Component
{
    ...
    {
        $this->dispatch('alert', ['type' => 'info', 'title' => 'Aguarde...',  'message' => 'Salvando rota, aguarde ser redirecionado...']);
        ...
        try {
            ...
            if ($route) {
                $this->dispatch('alert', ['type' => 'error', 'title' => 'Opss...',  'message' => 'Rota já cadastrada para está loja! Verifique os dados e tente novamente.']);
                return;
            }
            ...
            $this->dispatch('routeStore');

        } catch(\Exception $e){
            $this->dispatch('alert', ['type' => 'error',  'message' => 'Erro ao cadastrar rota!']);
        }
    }
    ...
    public function routeStore()
    {
        ...
        $this->dispatch('alert', ['type' => 'success', 'message' => 'Rota criada com sucesso.']);
