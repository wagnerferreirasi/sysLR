...
class LoginComponent extends Component
{
    ...
    public function validateLogin()
    {
        ...
        if(Auth::attempt($credentials, $this->remember)) {
            ...
            $this->dispatch('alert', ['type' => 'success',  'message' => 'Login realizado com sucesso! Redirecionando...']);

            return $this->redirect(route('dashboard'));

        } else {
            session()->flash('error', 'Login ou senha inválidos');
            $this->dispatch('alert', ['type' => 'error',  'message' => 'Erro ao realizar login! Verifique os dados informados e tente novamente.']);
